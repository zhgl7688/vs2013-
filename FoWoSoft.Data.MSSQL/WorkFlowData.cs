...
{
    public class WorkFlowData : FoWoSoft.Data.Interface.IWorkFlowData
    {
        ...
        /// 查询所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.WorkFlowData> GetAll()
        {
            string sql = "SELECT * FROM WorkFlowData";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<FoWoSoft.Data.Model.WorkFlowData> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public FoWoSoft.Data.Model.WorkFlowData Get(Guid id)
        {
        ...
        /// 查询一个实例ID所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.WorkFlowData> GetAll(Guid instanceID)
        {
