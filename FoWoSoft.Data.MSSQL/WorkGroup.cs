...
{
    public class WorkGroup : FoWoSoft.Data.Interface.IWorkGroup
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">FoWoSoft.Data.Model.WorkGroup实体类</param>
        /// <returns>操作所影响的行数</returns>
        public int Add(FoWoSoft.Data.Model.WorkGroup model)
        {
        ...
        /// </summary>
        /// <param name="model">FoWoSoft.Data.Model.WorkGroup实体类</param>
        public int Update(FoWoSoft.Data.Model.WorkGroup model)
        {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<FoWoSoft.Data.Model.WorkGroup> DataReaderToList(SqlDataReader dataReader)
        {
            List<FoWoSoft.Data.Model.WorkGroup> List = new List<FoWoSoft.Data.Model.WorkGroup>();
            FoWoSoft.Data.Model.WorkGroup model = null;
            while (dataReader.Read())
            {
                model = new FoWoSoft.Data.Model.WorkGroup();
        ...
        /// 查询所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.WorkGroup> GetAll()
        {
            string sql = "SELECT * FROM WorkGroup";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<FoWoSoft.Data.Model.WorkGroup> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public FoWoSoft.Data.Model.WorkGroup Get(Guid id)
        {
