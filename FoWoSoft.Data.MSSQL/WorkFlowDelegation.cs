...
{
    public class WorkFlowDelegation : FoWoSoft.Data.Interface.IWorkFlowDelegation
    {
        ...
        public List<FoWoSoft.Data.Model.WorkFlowDelegation> GetAll()
        {
            ...
            List<FoWoSoft.Data.Model.WorkFlowDelegation> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        public List<FoWoSoft.Data.Model.WorkFlowDelegation> GetPagerData(out string pager, string query = "", string userID="", string startTime = "", string endTime = "")
        {
            ...
            long count;
            int pageSize=FoWoSoft.Utility.Tools.GetPageSize();
            int pageNumber=FoWoSoft.Utility.Tools.GetPageNumber();
            ...
            pager = FoWoSoft.Utility.Tools.GetPagerHtml(count, pageSize, pageNumber, query);
        ...
        public List<FoWoSoft.Data.Model.WorkFlowDelegation> GetNoExpiredList()
        {
            ...
            SqlParameter[] parameters = new SqlParameter[]{
				new SqlParameter("@EndTime", SqlDbType.DateTime){ Value = FoWoSoft.Utility.DateTimeNew.Now }
			};
            SqlDataReader dataReader = dbHelper.GetDataReader(sql, parameters);
            List<FoWoSoft.Data.Model.WorkFlowDelegation> List = DataReaderToList(dataReader);
            dataReader.Close();
