...
{
    public class DBConnection : FoWoSoft.Data.Interface.IDBConnection
    {
        ...
        /// 查询所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.DBConnection> GetAll()
        {
            string sql = "SELECT * FROM DBConnection";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<FoWoSoft.Data.Model.DBConnection> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
