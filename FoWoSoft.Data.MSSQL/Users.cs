...
{
    public class Users : FoWoSoft.Data.Interface.IUsers
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">FoWoSoft.Data.Model.Users实体类</param>
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<FoWoSoft.Data.Model.Users> DataReaderToList(SqlDataReader dataReader)
        {
            List<FoWoSoft.Data.Model.Users> List = new List<FoWoSoft.Data.Model.Users>();
            FoWoSoft.Data.Model.Users model = null;
            while (dataReader.Read())
            {
                model = new FoWoSoft.Data.Model.Users();
        ...
        public List<FoWoSoft.Data.Model.Users> GetAll()
        {
            ...
            List<FoWoSoft.Data.Model.Users> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        public List<Model.Users> GetAllByOrganizeIDArray(Guid[] organizeIDArray)
        {
            ...
            string sql = "SELECT * FROM Users WHERE ID in(SELECT UserID FROM UsersRelation WHERE OrganizeID in(" + FoWoSoft.Utility.Tools.GetSqlInString(organizeIDArray) + ")) ORDER BY Sort";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<FoWoSoft.Data.Model.Users> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
