...
{
    public class WorkFlowForm : FoWoSoft.Data.Interface.IWorkFlowForm
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">FoWoSoft.Data.Model.WorkFlowForm实体类</param>
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<FoWoSoft.Data.Model.WorkFlowForm> DataReaderToList(SqlDataReader dataReader)
        {
            List<FoWoSoft.Data.Model.WorkFlowForm> List = new List<FoWoSoft.Data.Model.WorkFlowForm>();
            FoWoSoft.Data.Model.WorkFlowForm model = null;
            while (dataReader.Read())
            {
                model = new FoWoSoft.Data.Model.WorkFlowForm();
        ...
        public List<FoWoSoft.Data.Model.WorkFlowForm> GetAll()
        {
            ...
            List<FoWoSoft.Data.Model.WorkFlowForm> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 查询一个分类所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.WorkFlowForm> GetAllByType(string types)
        {
            string sql = "SELECT * FROM WorkFlowForm where Type IN(" + FoWoSoft.Utility.Tools.GetSqlInString(types) + ")";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<FoWoSoft.Data.Model.WorkFlowForm> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
