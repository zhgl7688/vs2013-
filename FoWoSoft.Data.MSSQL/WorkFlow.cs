...
{
    public class WorkFlow : FoWoSoft.Data.Interface.IWorkFlow
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">FoWoSoft.Data.Model.WorkFlow实体类</param>
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<FoWoSoft.Data.Model.WorkFlow> DataReaderToList(SqlDataReader dataReader)
        {
            List<FoWoSoft.Data.Model.WorkFlow> List = new List<FoWoSoft.Data.Model.WorkFlow>();
            FoWoSoft.Data.Model.WorkFlow model = null;
            while (dataReader.Read())
            {
                model = new FoWoSoft.Data.Model.WorkFlow();
        ...
        public List<FoWoSoft.Data.Model.WorkFlow> GetAll()
        {
            ...
            List<FoWoSoft.Data.Model.WorkFlow> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        {
            string sql = "SELECT * FROM WorkFlow where Type IN(" + FoWoSoft.Utility.Tools.GetSqlInString(typeString) + ")";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<FoWoSoft.Data.Model.WorkFlow> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
