...
namespace FoWoSoft.Data.MSSQL
{
    public class MeetInfo : FoWoSoft.Data.Interface.IMeetInfo
    {
        ...
        {
            string sql = "SELECT Id, ApplicatId, MeetTimes, MeetId, MeetName, AdminId,temp1,temp2 from  MeetInfo WHERE ApplicatId=@ApplicatId";
            SqlParameter[] parameters = new SqlParameter[]{
        ...
        {
            string sql = "SELECT Id, ApplicatId, MeetTimes, MeetId, MeetName, AdminId,temp1,temp2,temp3 from  MeetInfo WHERE MeetId=@MeetId";
            SqlParameter[] parameters = new SqlParameter[]{
        ...
        {
            string sql = "SELECT Id, ApplicatId, MeetTimes, MeetId, MeetName, AdminId,temp1,temp2,temp3 from  MeetInfo WHERE temp1=@temp1";
            SqlParameter[] parameters = new SqlParameter[]{
        ...
        {
            string sql = "SELECT Id, ApplicatId, MeetTimes, MeetId, MeetName, AdminId,temp1,temp2 from  MeetInfo ";
