...
{
    public class WorkFlowButtons : FoWoSoft.Data.Interface.IWorkFlowButtons
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">FoWoSoft.Data.Model.WorkFlowButtons实体类</param>
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<FoWoSoft.Data.Model.WorkFlowButtons> DataReaderToList(SqlDataReader dataReader)
        {
            List<FoWoSoft.Data.Model.WorkFlowButtons> List = new List<FoWoSoft.Data.Model.WorkFlowButtons>();
            FoWoSoft.Data.Model.WorkFlowButtons model = null;
            while (dataReader.Read())
            {
                model = new FoWoSoft.Data.Model.WorkFlowButtons();
        ...
        /// 查询所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.WorkFlowButtons> GetAll()
        {
            string sql = "SELECT * FROM WorkFlowButtons";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<FoWoSoft.Data.Model.WorkFlowButtons> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public FoWoSoft.Data.Model.WorkFlowButtons Get(Guid id)
        {
