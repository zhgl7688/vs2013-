...
{
    public class WorkFlowArchives : FoWoSoft.Data.Interface.IWorkFlowArchives
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">FoWoSoft.Data.Model.WorkFlowArchives实体类</param>
        /// <returns>操作所影响的行数</returns>
        public int Add(FoWoSoft.Data.Model.WorkFlowArchives model)
        {
        ...
        /// </summary>
        /// <param name="model">FoWoSoft.Data.Model.WorkFlowArchives实体类</param>
        public int Update(FoWoSoft.Data.Model.WorkFlowArchives model)
        {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<FoWoSoft.Data.Model.WorkFlowArchives> DataReaderToList(SqlDataReader dataReader)
        {
            List<FoWoSoft.Data.Model.WorkFlowArchives> List = new List<FoWoSoft.Data.Model.WorkFlowArchives>();
            FoWoSoft.Data.Model.WorkFlowArchives model = null;
            while (dataReader.Read())
            {
                model = new FoWoSoft.Data.Model.WorkFlowArchives();
        ...
        /// 查询所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.WorkFlowArchives> GetAll()
        {
            string sql = "SELECT * FROM WorkFlowArchives";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<FoWoSoft.Data.Model.WorkFlowArchives> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public FoWoSoft.Data.Model.WorkFlowArchives Get(Guid id)
        {
        ...
        public System.Data.DataTable GetPagerData(out string pager, string query = "", string title = "", string flowIDString = "")
        {
            ...
            {
                WHERE.AppendFormat("AND FlowID IN({0}) ", FoWoSoft.Utility.Tools.GetSqlInString(flowIDString));
            }
            long count;
