...
{
    public class Role : FoWoSoft.Data.Interface.IRole
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">FoWoSoft.Data.Model.Role实体类</param>
        /// <returns>操作所影响的行数</returns>
        public int Add(FoWoSoft.Data.Model.Role model)
        {
        ...
        /// </summary>
        /// <param name="model">FoWoSoft.Data.Model.Role实体类</param>
        public int Update(FoWoSoft.Data.Model.Role model)
        {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<FoWoSoft.Data.Model.Role> DataReaderToList(SqlDataReader dataReader)
        {
            List<FoWoSoft.Data.Model.Role> List = new List<FoWoSoft.Data.Model.Role>();
            FoWoSoft.Data.Model.Role model = null;
            while (dataReader.Read())
            {
                model = new FoWoSoft.Data.Model.Role();
        ...
        /// 查询所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.Role> GetAll()
        {
            string sql = "SELECT * FROM Role";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<FoWoSoft.Data.Model.Role> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public FoWoSoft.Data.Model.Role Get(Guid id)
        {
