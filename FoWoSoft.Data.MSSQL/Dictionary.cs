...
{
    public class Dictionary : FoWoSoft.Data.Interface.IDictionary
    {
        ...
        /// 查询所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.Dictionary> GetAll()
        {
            string sql = "SELECT * FROM Dictionary";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<FoWoSoft.Data.Model.Dictionary> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public FoWoSoft.Data.Model.Dictionary Get(Guid id)
        {
        ...
        /// 查询下级记录
        /// </summary>
        public List<FoWoSoft.Data.Model.Dictionary> GetChilds(Guid id)
        {
        ...
        /// 查询下级记录
        /// </summary>
        public List<FoWoSoft.Data.Model.Dictionary> GetChilds(string code)
        {
        ...
        /// 根据代码查询一条记录
        /// </summary>
        public FoWoSoft.Data.Model.Dictionary GetByCode(string code)
        {
