...
{
    public class UsersRole : FoWoSoft.Data.Interface.IUsersRole
    {
        ...
        public List<FoWoSoft.Data.Model.UsersRole> GetAll()
        {
            ...
            List<FoWoSoft.Data.Model.UsersRole> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public FoWoSoft.Data.Model.UsersRole Get(Guid memberid, Guid roleid)
        {
        ...
        /// 根据一组机构ID查询记录
        /// </summary>
        public List<FoWoSoft.Data.Model.UsersRole> GetByUserIDArray(Guid[] userIDArray)
        {
            string sql = "SELECT * FROM UsersRole WHERE MemberID IN(" + FoWoSoft.Utility.Tools.GetSqlInString(userIDArray) + ")";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<FoWoSoft.Data.Model.UsersRole> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        ...
        /// 根据人员ID查询记录
        /// </summary>
        public List<FoWoSoft.Data.Model.UsersRole> GetByUserID(Guid userID)
        {
