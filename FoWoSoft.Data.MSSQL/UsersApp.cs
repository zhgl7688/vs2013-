...
{
    public class UsersApp : FoWoSoft.Data.Interface.IUsersApp
    {
        ...
        public List<FoWoSoft.Data.Model.UsersApp> GetAll()
        {
            ...
            List<FoWoSoft.Data.Model.UsersApp> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 查询下级记录
        /// </summary>
        public List<FoWoSoft.Data.Model.UsersApp> GetChild(Guid id)
        {
