...
{
    public class RoleApp : FoWoSoft.Data.Interface.IRoleApp
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">FoWoSoft.Data.Model.RoleApp实体类</param>
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<FoWoSoft.Data.Model.RoleApp> DataReaderToList(SqlDataReader dataReader)
        {
            List<FoWoSoft.Data.Model.RoleApp> List = new List<FoWoSoft.Data.Model.RoleApp>();
            FoWoSoft.Data.Model.RoleApp model = null;
            while (dataReader.Read())
            {
                model = new FoWoSoft.Data.Model.RoleApp();
        ...
        public List<FoWoSoft.Data.Model.RoleApp> GetAll()
        {
            ...
            List<FoWoSoft.Data.Model.RoleApp> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
