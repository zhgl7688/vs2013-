...
{
    public class Organize : FoWoSoft.Data.Interface.IOrganize
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">FoWoSoft.Data.Model.Organize实体类</param>
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<FoWoSoft.Data.Model.Organize> DataReaderToList(SqlDataReader dataReader)
        {
            List<FoWoSoft.Data.Model.Organize> List = new List<FoWoSoft.Data.Model.Organize>();
            FoWoSoft.Data.Model.Organize model = null;
            while (dataReader.Read())
            {
                model = new FoWoSoft.Data.Model.Organize();
        ...
        public List<FoWoSoft.Data.Model.Organize> GetAll()
        {
            ...
            List<FoWoSoft.Data.Model.Organize> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        {
            string sql = "SELECT * FROM Organize WHERE ID IN(" + FoWoSoft.Utility.Tools.GetSqlInString(number) + ") ORDER BY Depth";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<FoWoSoft.Data.Model.Organize> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        ...
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.Organize> GetAllChild(string number)
        {
