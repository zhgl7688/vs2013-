...
{
    public class WorkFlowComment : FoWoSoft.Data.Interface.IWorkFlowComment
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">FoWoSoft.Data.Model.WorkFlowComment实体类</param>
        /// <returns>操作所影响的行数</returns>
        public int Add(FoWoSoft.Data.Model.WorkFlowComment model)
        {
        ...
        /// </summary>
        /// <param name="model">FoWoSoft.Data.Model.WorkFlowComment实体类</param>
        public int Update(FoWoSoft.Data.Model.WorkFlowComment model)
        {
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<FoWoSoft.Data.Model.WorkFlowComment> DataReaderToList(SqlDataReader dataReader)
        {
            List<FoWoSoft.Data.Model.WorkFlowComment> List = new List<FoWoSoft.Data.Model.WorkFlowComment>();
            FoWoSoft.Data.Model.WorkFlowComment model = null;
            while (dataReader.Read())
            {
                model = new FoWoSoft.Data.Model.WorkFlowComment();
        ...
        /// 查询所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.WorkFlowComment> GetAll()
        {
            string sql = "SELECT * FROM WorkFlowComment";
            SqlDataReader dataReader = dbHelper.GetDataReader(sql);
            List<FoWoSoft.Data.Model.WorkFlowComment> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
        ...
        /// 根据主键查询一条记录
        /// </summary>
        public FoWoSoft.Data.Model.WorkFlowComment Get(Guid id)
        {
        ...
        /// 查询管理员的所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.WorkFlowComment> GetManagerAll()
        {
