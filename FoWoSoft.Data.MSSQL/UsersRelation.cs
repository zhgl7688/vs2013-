...
{
    public class UsersRelation : FoWoSoft.Data.Interface.IUsersRelation
    {
        ...
        /// 添加记录
        /// </summary>
        /// <param name="model">FoWoSoft.Data.Model.UsersRelation实体类</param>
        ...
        /// 将DataRedar转换为List
        /// </summary>
        private List<FoWoSoft.Data.Model.UsersRelation> DataReaderToList(SqlDataReader dataReader)
        {
            List<FoWoSoft.Data.Model.UsersRelation> List = new List<FoWoSoft.Data.Model.UsersRelation>();
            FoWoSoft.Data.Model.UsersRelation model = null;
            while (dataReader.Read())
            {
                model = new FoWoSoft.Data.Model.UsersRelation();
        ...
        public List<FoWoSoft.Data.Model.UsersRelation> GetAll()
        {
            ...
            List<FoWoSoft.Data.Model.UsersRelation> List = DataReaderToList(dataReader);
            dataReader.Close();
            return List;
        }
        /// <summary>
