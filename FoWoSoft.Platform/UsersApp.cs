...
namespace FoWoSoft.Platform
{
    ...
    {
        private FoWoSoft.Data.Interface.IUsersApp dataUsersApp;
        public UsersApp()
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.UsersApp> GetAll()
        {
        ...
        /// 查询单条记录
        /// </summary>
        public FoWoSoft.Data.Model.UsersApp Get(Guid id)
        {
        ...
        {
            string cacheKey = FoWoSoft.Utility.Keys.CacheKeys.UsersApp.ToString();
            if (fromCache)
            {
                ...
                if (obj == null || !(obj is System.Data.DataTable))
                {
                    ...
                    FoWoSoft.Cache.IO.Opation.Insert(cacheKey, dt);
                    return dt;
                }
                else
                {
        ...
        public void AppendUserApps(Guid userID, Guid parentID, List<FoWoSoft.Data.Model.RoleApp> appList)
        {
            ...
            foreach (var userApp in userApps)
            {
                ...
                {
                    FoWoSoft.Data.Model.RoleApp app = new FoWoSoft.Data.Model.RoleApp();
        ...
        /// 查询下级记录
        /// </summary>
        public List<FoWoSoft.Data.Model.UsersApp> GetChilds(Guid id)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.UsersApp> GetAllChilds(Guid id)
        {
        ...
        private void addChilds(Guid id, List<FoWoSoft.Data.Model.UsersApp> list)
        {
