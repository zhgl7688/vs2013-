...
{
    public class WorkFlowTask : IEqualityComparer<FoWoSoft.Data.Model.WorkFlowTask>
    {
        private WorkFlow bWorkFlow = new WorkFlow();
        private FoWoSoft.Data.Interface.IWorkFlowTask dataWorkFlowTask;
        ...
        /// <returns></returns>
        public bool Equals(FoWoSoft.Data.Model.WorkFlowTask task1, FoWoSoft.Data.Model.WorkFlowTask task2)
        {
            return task1.ReceiveID == task2.ReceiveID;
        }

        public int GetHashCode(FoWoSoft.Data.Model.WorkFlowTask task)
        {
        ...
        public string GetStepSnderIDString(Guid flowID, Guid stepID, Guid groupID)
        {
            ...
            {
                sb.Append(FoWoSoft.Platform.Users.PREFIX);
                sb.Append(li);
                sb.Append(",");
            }
        ...
        /// <returns></returns>
        private FoWoSoft.Data.Model.WorkFlowExecute.Execute GetExecuteModel(string jsonString)
        {
            FoWoSoft.Data.Model.WorkFlowExecute.Execute execute = new FoWoSoft.Data.Model.WorkFlowExecute.Execute();
            FoWoSoft.Platform.Organize borganize = new Organize();
            ...
            switch (op)
            {
                case "submit":
                    ...
                    break;
                case "save":
                    execute.ExecuteType = FoWoSoft.Data.Model.WorkFlowExecute.EnumType.ExecuteType.Save;
                    break;
                case "back":
        ...
        /// <param name="jsonString"></param>
        /// <returns></returns>
        public FoWoSoft.Data.Model.WorkFlowExecute.Result Execute(string jsonString)
        {
        ...
        public bool StartFlow(Guid flowID, List<Data.Model.Users> users, string title, string instanceID = "")
        {
            ...
            try
            {
                ...
                {
                    FoWoSoft.Data.Model.WorkFlowExecute.Execute executeModel = new Data.Model.WorkFlowExecute.Execute();
        ...
        /// <returns></returns>
        public FoWoSoft.Data.Model.WorkFlowExecute.Result Execute(FoWoSoft.Data.Model.WorkFlowExecute.Execute executeModel)
        {
            result = new FoWoSoft.Data.Model.WorkFlowExecute.Result();
            nextTasks = new List<FoWoSoft.Data.Model.WorkFlowTask>();
            ...
            lock (executeModel.GroupID.ToString())
            {
                ...
                {
                    case FoWoSoft.Data.Model.WorkFlowExecute.EnumType.ExecuteType.Back:
        ...
        private void executeSubmit(FoWoSoft.Data.Model.WorkFlowExecute.Execute executeModel)
        {
            using (System.Transactions.TransactionScope scope = new System.Transactions.TransactionScope())
            {
                //如果是第一步提交并且没有实例则先创建实例
                FoWoSoft.Data.Model.WorkFlowTask currentTask = null;
                ...
                foreach (var step in executeModel.Steps)
                {
                    foreach (var user in step.Value)
                    {
                        ...
                        if (isPassing)
                        {
                            FoWoSoft.Data.Model.WorkFlowTask task = new FoWoSoft.Data.Model.WorkFlowTask();
                            if (nextStep.WorkTime > 0)
                            {
                                task.CompletedTime = FoWoSoft.Utility.DateTimeNew.Now.AddHours((double)nextStep.WorkTime);
                            }
                            ...
                            task.ReceiveTime = FoWoSoft.Utility.DateTimeNew.Now;
                            ...
                            {
                                FoWoSoft.Data.Model.WorkFlowExecute.Execute subflowExecuteModel = new FoWoSoft.Data.Model.WorkFlowExecute.Execute();
                                if (!nextStep.Event.SubFlowActivationBefore.IsNullOrEmpty())
                                {
                                    object obj = ExecuteFlowCustomEvent(nextStep.Event.SubFlowActivationBefore.Trim(),
                                        new FoWoSoft.Data.Model.WorkFlowCustomEventParams()
                                        {
                                    ...
                                    if (obj is FoWoSoft.Data.Model.WorkFlowExecute.Execute)
                                    {
                                        subflowExecuteModel = obj as FoWoSoft.Data.Model.WorkFlowExecute.Execute;
                                    }
                                }
                                subflowExecuteModel.ExecuteType = FoWoSoft.Data.Model.WorkFlowExecute.EnumType.ExecuteType.Save;
        ...
        private void executeBack(FoWoSoft.Data.Model.WorkFlowExecute.Execute executeModel)
        {
            ...
            using (System.Transactions.TransactionScope scope = new System.Transactions.TransactionScope())
            {
                List<FoWoSoft.Data.Model.WorkFlowTask> backTasks = new List<FoWoSoft.Data.Model.WorkFlowTask>();
                int status = 0;
                ...
                List<FoWoSoft.Data.Model.WorkFlowTask> tasks = new List<FoWoSoft.Data.Model.WorkFlowTask>();
                ...
                if (isBack)
                {
                    ...
                    foreach (var task in backTaskList)
                    {
                        if (task != null)
                        {
                            ...
                            FoWoSoft.Data.Model.WorkFlowTask newTask = task;
                            newTask.ID = Guid.NewGuid();
                            newTask.PrevID = currentTask.ID;
                            newTask.Note = "退回任务";
                            newTask.ReceiveTime = FoWoSoft.Utility.DateTimeNew.Now;
                            newTask.SenderID = currentTask.ReceiveID;
                            newTask.SenderName = currentTask.ReceiveName;
                            newTask.SenderTime = FoWoSoft.Utility.DateTimeNew.Now;
                            ...
                            {
                                newTask.CompletedTime = FoWoSoft.Utility.DateTimeNew.Now.AddHours((double)currentStep.WorkTime);
                            }
                            else
                            {
        ...
        /// </summary>
        /// <param name="executeModel"></param>
        private void executeSave(FoWoSoft.Data.Model.WorkFlowExecute.Execute executeModel)
        {
            //如果是第一步提交并且没有实例则先创建实例
            FoWoSoft.Data.Model.WorkFlowTask currentTask = null;
            bool isFirst = executeModel.StepID == wfInstalled.FirstStepID && executeModel.TaskID == Guid.Empty && executeModel.GroupID == Guid.Empty;
        ...
        private void executeComplete(FoWoSoft.Data.Model.WorkFlowExecute.Execute executeModel, bool isCompleteTask = true)
        {
            ...
            if (parentTasks.Count > 0)
            {
                ...
                if (flowRunModel != null)
                {
                    ...
                    {
                        ExecuteFlowCustomEvent(steps.First().Event.SubFlowCompletedBefore.Trim(), new FoWoSoft.Data.Model.WorkFlowCustomEventParams()
                        {
        ...
        /// </summary>
        /// <param name="executeModel"></param>
        private void executeRedirect(FoWoSoft.Data.Model.WorkFlowExecute.Execute executeModel)
        {
            FoWoSoft.Data.Model.WorkFlowTask currentTask = Get(executeModel.TaskID);
            if (currentTask == null)
            {
                result.DebugMessages = "未能创建或找到当前任务";
                result.IsSuccess = false;
        ...
        /// </summary>
        /// <param name="executeModel"></param>
        private List<Data.Model.WorkFlowTask> createTempTasks(FoWoSoft.Data.Model.WorkFlowExecute.Execute executeModel, Data.Model.WorkFlowTask currentTask)
        {
        ...
        /// <param name="groupID"></param>
        /// <returns></returns>
        private bool IsPassing(FoWoSoft.Data.Model.WorkFlowInstalledSub.Step step, Guid flowID, Guid groupID, Guid taskID, int sort)
        {
        ...
        /// <param name="groupID"></param>
        /// <returns></returns>
        private bool IsBack(FoWoSoft.Data.Model.WorkFlowInstalledSub.Step step, Guid flowID, Guid groupID, Guid taskID, int sort)
        {
            var tasks = GetTaskList(flowID, step.ID, groupID).FindAll(p => p.Sort == sort && p.Type != 5);
            if (tasks.Count == 0)
            {
        ...
        /// <returns></returns>
        private FoWoSoft.Data.Model.WorkFlowTask createFirstTask(FoWoSoft.Data.Model.WorkFlowExecute.Execute executeModel, bool isSubFlow = false)
        {
            ...
            {
                task.CompletedTime = FoWoSoft.Utility.DateTimeNew.Now.AddHours((double)nextSteps.First().WorkTime);
            }
            task.FlowID = executeModel.FlowID;
        ...
        {
            return dataWorkFlowTask.GetTasks(userID, out pager, query, title, flowid, FoWoSoft.Platform.Users.RemovePrefix(sender), date1, date2, type);
        }
        ...
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.WorkFlowTask> GetInstances(Guid[] flowID, Guid[] senderID, Guid[] receiveID, out string pager, string query = "", string title = "", string flowid = "", string date1 = "", string date2 = "", int status = 0)
        {
        ...
        /// <param name="groupID"></param>
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.WorkFlowTask> GetTaskList(Guid flowID, Guid stepID, Guid groupID)
        {
        ...
        /// <param name="groupID"></param>
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.WorkFlowTask> GetTaskList(Guid flowID, Guid groupID)
        {
        ...
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.WorkFlowTask> GetTaskList(Guid taskID, bool isStepID = true)
        {
        ...
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.WorkFlowTask> GetTaskListByStepID(Guid taskID, Guid stepID)
        {
        ...
        /// <param name="groupID"></param>
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.WorkFlowTask> GetPrevTaskList(Guid taskID)
        {
        ...
        /// <param name="groupID"></param>
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.WorkFlowTask> GetNextTaskList(Guid taskID)
        {
        ...
        /// <param name="stepID"></param>
        /// <returns></returns>
        public Dictionary<Guid, string> GetBackSteps(Guid taskID, int backType, Guid stepID, FoWoSoft.Data.Model.WorkFlowInstalled wfInstalled)
        {
        ...
        /// <param name="userID"></param>
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.WorkFlowTask> GetUserTaskList(Guid flowID, Guid stepID, Guid groupID, Guid userID)
        {
        ...
        /// <returns></returns>
        public string DesignateTask(Guid taskID, FoWoSoft.Data.Model.Users user)
        {
            var task = Get(taskID);
            if (task == null)
            {
        ...
        public string BackTask(Guid taskID)
        {
            ...
            FoWoSoft.Data.Model.WorkFlowExecute.Execute executeModel = new FoWoSoft.Data.Model.WorkFlowExecute.Execute();
            executeModel.ExecuteType = FoWoSoft.Data.Model.WorkFlowExecute.EnumType.ExecuteType.Back;
            ...
            Dictionary<Guid, List<FoWoSoft.Data.Model.Users>> execSteps = new Dictionary<Guid, List<FoWoSoft.Data.Model.Users>>();
            var backsteps = GetBackSteps(taskID, steps.First().Behavior.BackType, task.StepID, wfInstalled);
            foreach (var back in backsteps)
            {
                execSteps.Add(back.Key, new List<FoWoSoft.Data.Model.Users>());
            }
        ...
        public List<FoWoSoft.Data.Model.WorkFlowTask> Sort(List<FoWoSoft.Data.Model.WorkFlowTask> tasks)
        {
        ...
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.WorkFlowTask> GetBySubFlowGroupID(Guid subflowGroupID)
        {
