...
namespace FoWoSoft.Platform
{
    ...
    {
        private FoWoSoft.Data.Interface.IDictionary dataDictionary;
        private static string cacheKey = FoWoSoft.Utility.Keys.CacheKeys.Dictionary.ToString();
        public Dictionary()
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.Dictionary> GetAll(bool fromCache=false)
        {
            if (!fromCache)
            {
            ...
            {
                object obj = FoWoSoft.Cache.IO.Opation.Get(cacheKey);
                if (obj != null && obj is List<FoWoSoft.Data.Model.Dictionary>)
                {
                    return obj as List<FoWoSoft.Data.Model.Dictionary>;
                }
                else
                {
                    var list = dataDictionary.GetAll();
                    FoWoSoft.Cache.IO.Opation.Set(cacheKey, list);
                    return list;
                }
            }
        }
        ...
        /// 查询单条记录
        /// </summary>
        public FoWoSoft.Data.Model.Dictionary Get(Guid id, bool fromCache = false)
        {
        ...
        /// 查询根记录
        /// </summary>
        public FoWoSoft.Data.Model.Dictionary GetRoot()
        {
        ...
        /// 查询下级记录
        /// </summary>
        public List<FoWoSoft.Data.Model.Dictionary> GetChilds(Guid id, bool fromCache=false)
        {
        ...
        /// 查询下级记录
        /// </summary>
        public List<FoWoSoft.Data.Model.Dictionary> GetChilds(string code, bool fromCache=false)
        {
            return code.IsNullOrEmpty() ? new List<FoWoSoft.Data.Model.Dictionary>() :
                fromCache ? getChildsByCodeFromCache(code) :
                dataDictionary.GetChilds(code.Trim());
        }

        private List<FoWoSoft.Data.Model.Dictionary> getChildsByCodeFromCache(string code)
        {
            var list = GetAll(true);
            var dict = list.Find(p => string.Compare(p.Code, code, true) == 0);
            return dict == null ? new List<FoWoSoft.Data.Model.Dictionary>() : list.FindAll(p => p.ParentID == dict.ID).OrderBy(p=>p.Sort).ToList();
        }

        private List<FoWoSoft.Data.Model.Dictionary> getChildsByIDFromCache(Guid id)
        {
            var list = GetAll(true);
        ...
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.Dictionary> GetAllChilds(string code, bool fromCache)
        {
            if (code.IsNullOrEmpty()) return new List<FoWoSoft.Data.Model.Dictionary>();
            var dict = GetByCode(code, fromCache);
            if (dict == null) return new List<FoWoSoft.Data.Model.Dictionary>();
        ...
        /// <param name="fromCache">是否使用缓存</param>
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.Dictionary> GetAllChilds(Guid id, bool fromCache=false)
        {
        ...
        private void addChilds(List<FoWoSoft.Data.Model.Dictionary> list, Guid id, bool fromCache=false)
        {
        ...
        /// 查询上级记录
        /// </summary>
        public FoWoSoft.Data.Model.Dictionary GetParent(Guid id)
        {
        ...
        /// <param name="fromCache">是否使用缓存</param>
        /// <returns></returns>
        public FoWoSoft.Data.Model.Dictionary GetByCode(string code, bool fromCache=false)
        {
        ...
        private string getRadios(List<FoWoSoft.Data.Model.Dictionary> childs, string name, OptionValueField valueField = OptionValueField.Value, string value = "", string attr = "")
        {
            StringBuilder options = new StringBuilder(childs.Count * 100);
            foreach (var child in childs)
            {
        ...
        private string getCheckboxs(List<FoWoSoft.Data.Model.Dictionary> childs, string name, OptionValueField valueField = OptionValueField.Value, string value = "", string attr = "")
        {
            StringBuilder options = new StringBuilder(childs.Count * 100);
            foreach (var child in childs)
            {
        ...
        {
            FoWoSoft.Cache.IO.Opation.Set(cacheKey, GetAll());
        }
        ...
        /// <returns></returns>
        public string GetComboxTableHtmlByID(string id, FoWoSoft.Platform.Dictionary.OptionValueField valueField, string defaultValue)
        {
            if (!id.IsGuid())
            {
                return "";
