...
namespace FoWoSoft.Platform
{
    ...
    {
        private FoWoSoft.Data.Interface.IDBConnection dataDBConnection;
        public DBConnection()
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.DBConnection> GetAll(bool fromCache=false)
        {
            if (!fromCache)
            {
            ...
            {
                string key = FoWoSoft.Utility.Keys.CacheKeys.DBConnnections.ToString();
                object obj = FoWoSoft.Cache.IO.Opation.Get(key);
                if (obj != null && obj is List<FoWoSoft.Data.Model.DBConnection>)
                {
                    return obj as List<FoWoSoft.Data.Model.DBConnection>;
                }
                else
                {
        ...
        /// 查询单条记录
        /// </summary>
        public FoWoSoft.Data.Model.DBConnection Get(Guid id)
        {
