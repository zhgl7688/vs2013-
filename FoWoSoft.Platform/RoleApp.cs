...
namespace FoWoSoft.Platform
{
    ...
    {
        private FoWoSoft.Data.Interface.IRoleApp dataRoleApp;
        public RoleApp()
        {
        ...
        /// 新增
        /// </summary>
        public int Add(FoWoSoft.Data.Model.RoleApp model)
        {
        ...
        /// 更新
        /// </summary>
        public int Update(FoWoSoft.Data.Model.RoleApp model)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.RoleApp> GetAll()
        {
        ...
        /// 查询单条记录
        /// </summary>
        public FoWoSoft.Data.Model.RoleApp Get(Guid id)
        {
        ...
        /// 查询一个角色所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.RoleApp> GetAllByRoleID(Guid roleID)
        {
        ...
        {
            string key = FoWoSoft.Utility.Keys.CacheKeys.RoleApp.ToString();
            ...
            if (obj == null || !(obj is System.Data.DataTable))
            {
                ...
                FoWoSoft.Cache.IO.Opation.Set(key, dt);
                return dt;
            }
            else
            {
        ...
        /// 查询下级记录
        /// </summary>
        public List<FoWoSoft.Data.Model.RoleApp> GetChild(Guid id)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.RoleApp> GetAllChild(Guid id)
        {
            List<FoWoSoft.Data.Model.RoleApp> list = new List<FoWoSoft.Data.Model.RoleApp>();
        ...
        private void addChilds(List<FoWoSoft.Data.Model.RoleApp> list, Guid id)
        {
            var childs = GetChild(id);
            foreach (var child in childs)
            {
        ...
        private void insertChilds(Guid oldID, Guid newID, Guid roleID, List<FoWoSoft.Data.Model.RoleApp> apps)
        {
        ...
        /// <param name="roleID"></param>
        /// <returns></returns>
        public FoWoSoft.Data.Model.RoleApp GetRootByRoleID(Guid roleID)
        {
