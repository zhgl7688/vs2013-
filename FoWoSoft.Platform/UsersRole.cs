...
namespace FoWoSoft.Platform
{
    ...
    {
        private static string cacheKey = FoWoSoft.Utility.Keys.CacheKeys.UserRoles.ToString();
        private FoWoSoft.Data.Interface.IUsersRole dataUsersRole;
        public UsersRole()
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.UsersRole> GetAll()
        {
        ...
        /// 查询单条记录
        /// </summary>
        public FoWoSoft.Data.Model.UsersRole Get(Guid userid, Guid roleid)
        {
        ...
        /// 根据一组用户ID查询记录
        /// </summary>
        public List<FoWoSoft.Data.Model.UsersRole> GetByUserIDArray(Guid[] memberIDArray)
        {
        ...
        /// 根据用户ID查询记录
        /// </summary>
        public List<FoWoSoft.Data.Model.UsersRole> GetByUserID(Guid memberID)
        {
        ...
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.UsersRole> GetByUserIDFromCache(Guid userID)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.UsersRole> GetAllFromCache()
        {
            var obj = FoWoSoft.Cache.IO.Opation.Get(cacheKey);
            if (obj == null || !(obj is List<FoWoSoft.Data.Model.UsersRole>))
            {
                var list = GetAll();
            ...
            {
                return obj as List<FoWoSoft.Data.Model.UsersRole>;
            }
        }
