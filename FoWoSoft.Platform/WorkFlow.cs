...
namespace FoWoSoft.Platform
{
    ...
    {
        private FoWoSoft.Data.Interface.IWorkFlow dataWorkFlow;
        public WorkFlow()
        {
        ...
        /// 新增
        /// </summary>
        public int Add(FoWoSoft.Data.Model.WorkFlow model)
        {
        ...
        /// 更新
        /// </summary>
        public int Update(FoWoSoft.Data.Model.WorkFlow model)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.WorkFlow> GetAll()
        {
        ...
        /// 查询单条记录
        /// </summary>
        public FoWoSoft.Data.Model.WorkFlow Get(Guid id)
        {
        ...
        public string SaveFlow(string jsonString)
        {
            ...
            else
            {
                ...
                FoWoSoft.Data.Model.WorkFlow wf = bwf.Get(flowID);
                bool isAdd = false;
                if (wf == null)
                {
                    wf = new FoWoSoft.Data.Model.WorkFlow();
                    isAdd = true;
                    wf.ID = flowID;
                    wf.CreateDate = FoWoSoft.Utility.DateTimeNew.Now;
                    wf.CreateUserID = FoWoSoft.Platform.Users.CurrentUserID;
                    wf.Status = 1;
                }
        ...
        public string InstallFlow(string jsonString, bool isMvc = true)
        {
            ...
            FoWoSoft.Data.Model.WorkFlowInstalled wfInstalled = GetWorkFlowRunModel(jsonString, out errMsg);
            if (wfInstalled == null)
            {
                return errMsg;
            }
            ...
            {
                FoWoSoft.Data.Model.WorkFlow wf = dataWorkFlow.Get(wfInstalled.ID);
                if (wf == null)
                {
                    return "流程实体为空";
                }
                else
                {
                    using (System.Transactions.TransactionScope scope = new System.Transactions.TransactionScope())
                    {
                        ...
                        #region 添加到应用程序库
                        FoWoSoft.Platform.AppLibrary bappLibrary = new AppLibrary();
                        FoWoSoft.Data.Model.AppLibrary app = bappLibrary.GetByCode(wfInstalled.ID.ToString());
                        bool isAdd = false;
                        if (app == null)
                        {
                            isAdd = true;
                        ...
                        new FoWoSoft.Platform.RoleApp().ClearAllDataTableCache();
                        #endregion
                        FoWoSoft.Cache.IO.Opation.Set(getCacheKey(wfInstalled.ID), wfInstalled);
                        scope.Complete();
                        return "1";
                    }
                }
        ...
        public FoWoSoft.Data.Model.WorkFlow SaveAs(Guid flowID, string newName)
        {
            FoWoSoft.Data.Model.WorkFlow wf = dataWorkFlow.Get(flowID);
        ...
        {
            return string.Concat(FoWoSoft.Utility.Keys.CacheKeys.WorkFlowInstalled_.ToString(), flowID.ToString("N"));
        }
        ...
        /// <param name="flowID">流程ID</param>
        /// <returns></returns>
        public FoWoSoft.Data.Model.WorkFlowInstalled GetWorkFlowRunModel(string flowID, bool cache = true)
        {
            Guid fid;
        ...
        /// <param name="flowID">流程ID</param>
        /// <returns></returns>
        public FoWoSoft.Data.Model.WorkFlowInstalled GetWorkFlowRunModel(Guid flowID, bool cache = true)
        {
            if (!cache)
            {
            ...
            else
            {
                ...
                if (obj == null)
                {
                    ...
                    FoWoSoft.Cache.IO.Opation.Set(key, wfi);
                    return wfi;
                }
                else
                {
                    return obj as FoWoSoft.Data.Model.WorkFlowInstalled;
                }
            }
  
        }

        private FoWoSoft.Data.Model.WorkFlowInstalled getWorkFlowRunFromDesign(Guid flowID)
        {
            var wf = Get(flowID);
        ...
        {
            string key = getCacheKey(flowID);
            FoWoSoft.Cache.IO.Opation.Set(key, GetWorkFlowRunModel(flowID, false));
        }
        ...
        public FoWoSoft.Data.Model.WorkFlowInstalled GetWorkFlowRunModel(string jsonString, out string errMsg)
        {
            errMsg = "";
            FoWoSoft.Data.Model.WorkFlowInstalled wfInstalled = new FoWoSoft.Data.Model.WorkFlowInstalled();
            ...
            wfInstalled.DebugUsers = new FoWoSoft.Platform.Organize().GetAllUsers(json["debugUsers"].ToString());
            wfInstalled.Note = json["note"].ToString();
            wfInstalled.FlowType = json.ContainsKey("flowType") ? json["flowType"].ToString().ToInt() : 0;

            List<FoWoSoft.Data.Model.WorkFlowInstalledSub.DataBases> dataBases = new List<FoWoSoft.Data.Model.WorkFlowInstalledSub.DataBases>();
            var dbs = json["databases"];
            if (dbs.IsArray)
            {
                foreach (LitJson.JsonData db in dbs)
                {
                    dataBases.Add(new FoWoSoft.Data.Model.WorkFlowInstalledSub.DataBases()
                    {
            ...
            {
                wfInstalled.TitleField = new FoWoSoft.Data.Model.WorkFlowInstalledSub.TitleField()
                {
            ...
            #region 载入步骤信息
            List<FoWoSoft.Data.Model.WorkFlowInstalledSub.Step> stepsList = new List<FoWoSoft.Data.Model.WorkFlowInstalledSub.Step>();
            LitJson.JsonData steps = json["steps"];
            if (steps.IsArray)
            {
                foreach (LitJson.JsonData step in steps)
                {
                    ...
                    FoWoSoft.Data.Model.WorkFlowInstalledSub.StepSet.Behavior behavior1 = new FoWoSoft.Data.Model.WorkFlowInstalledSub.StepSet.Behavior();
                    ...
                    List<FoWoSoft.Data.Model.WorkFlowInstalledSub.StepSet.Button> buttionList = new List<FoWoSoft.Data.Model.WorkFlowInstalledSub.StepSet.Button>();
                    if (buttons.IsArray)
                    {
                        foreach (LitJson.JsonData button in buttons)
                        {
                            ...
                            if (butID.IsGuid())
                            {
                                ...
                                buttionList.Add(new FoWoSoft.Data.Model.WorkFlowInstalledSub.StepSet.Button()
                                {
                                    ID = butID,
                    ...
                    FoWoSoft.Data.Model.WorkFlowInstalledSub.StepSet.Event event2 = new FoWoSoft.Data.Model.WorkFlowInstalledSub.StepSet.Event();
                    if (event1.IsObject)
                    {
                    ...
                    List<FoWoSoft.Data.Model.WorkFlowInstalledSub.StepSet.Form> formList = new List<FoWoSoft.Data.Model.WorkFlowInstalledSub.StepSet.Form>();
                    if (forms.IsArray)
                    {
                        foreach (LitJson.JsonData form in forms)
                        {
                            formList.Add(new FoWoSoft.Data.Model.WorkFlowInstalledSub.StepSet.Form()
                            {
                    ...
                    List<FoWoSoft.Data.Model.WorkFlowInstalledSub.StepSet.FieldStatus> fieldStatusList = new List<FoWoSoft.Data.Model.WorkFlowInstalledSub.StepSet.FieldStatus>();
                    if (fieldStatus.IsArray)
                    {
                        foreach (LitJson.JsonData field in fieldStatus)
                        {
                            fieldStatusList.Add(new FoWoSoft.Data.Model.WorkFlowInstalledSub.StepSet.FieldStatus()
                            {
                    ...
                    stepsList.Add(new FoWoSoft.Data.Model.WorkFlowInstalledSub.Step()
                    {
            ...
            List<FoWoSoft.Data.Model.WorkFlowInstalledSub.Line> linesList = new List<FoWoSoft.Data.Model.WorkFlowInstalledSub.Line>();
            LitJson.JsonData lines = json.ContainsKey("lines") ? json["lines"] : null;
            if (lines != null && lines.IsArray)
            {
                foreach (LitJson.JsonData line in lines)
                {
                    linesList.Add(new FoWoSoft.Data.Model.WorkFlowInstalledSub.Line()
                    {
            ...
            */
            ...
            if (wf != null)
            {
                ...
                wfInstalled.InstallTime = FoWoSoft.Utility.DateTimeNew.Now;
        ...
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.WorkFlowInstalledSub.Step> GetAllPrevSteps(Guid flowID, Guid stepID)
        {
            List<FoWoSoft.Data.Model.WorkFlowInstalledSub.Step> stepList = new List<FoWoSoft.Data.Model.WorkFlowInstalledSub.Step>();
        ...
        private void addPrevSteps(List<FoWoSoft.Data.Model.WorkFlowInstalledSub.Step> list, FoWoSoft.Data.Model.WorkFlowInstalled wfInstalled, Guid stepID)
        {
        ...
        /// <param name="stepID"></param>
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.WorkFlowInstalledSub.Step> GetPrevSteps(Guid flowID, Guid stepID)
        {
            List<FoWoSoft.Data.Model.WorkFlowInstalledSub.Step> stepList = new List<FoWoSoft.Data.Model.WorkFlowInstalledSub.Step>();
            var wfInstalled = GetWorkFlowRunModel(flowID);
            if (wfInstalled == null)
        ...
        /// <param name="stepID"></param>
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.WorkFlowInstalledSub.Step> GetNextSteps(Guid flowID, Guid stepID)
        {
            List<FoWoSoft.Data.Model.WorkFlowInstalledSub.Step> stepList = new List<FoWoSoft.Data.Model.WorkFlowInstalledSub.Step>();
            var wfInstalled = GetWorkFlowRunModel(flowID);
            if (wfInstalled == null)
        ...
        /// <param name="defautFirstStepName">如果步骤ID为空是否默认为第一步</param>
        /// <returns></returns>
        public string GetStepName(Guid stepID, FoWoSoft.Data.Model.WorkFlowInstalled wfinstalled, bool defautFirstStepName = false)
        {
            if (wfinstalled == null) return "";
        ...
        /// 保存表单数据
        /// </summary>
        public string SaveFromData(string instanceid, FoWoSoft.Data.Model.WorkFlowCustomEventParams eventParams)
        {
            //保存自定义表单内容
            ...
            FoWoSoft.Data.Model.DBConnection dbconn = bdbconn.Get(dbconnid.ToGuid());
            if (dbconn == null)
            {
                return instanceid;
            }
        ...
        public LitJson.JsonData GetFormData(string connid, string table, string pk, string instanceid, string filedStatus = "")
        {
            ...
            FoWoSoft.Platform.DBConnection bdbconn = new FoWoSoft.Platform.DBConnection();
            FoWoSoft.Data.Model.DBConnection dbconn = bdbconn.Get(connid.ToGuid());
            if (dbconn == null)
            {
                return "";
            }
        ...
        /// <param name="stepID"></param>
        /// <returns></returns>
        public Dictionary<string, int> GetFieldStatusAndCheck(string flowID, string stepID)
        {
            Guid fid, sid;
            if (!flowID.IsGuid(out fid))
            {
           ...
           var dic = new Dictionary<string, int>();
            foreach (var fs in fieldStatus)
            {
                ...
                dic.Add(fields[2], fs.Status1);
                 
               // dic.Add(fields[2], string.Concat(fs.Status1, "_", fs.Check));
            }
            return dic;
        }
        /// <summary>
        ...
        /// 查询所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.WorkFlow> GetByTypes(string typeString)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public FoWoSoft.Data.Model.WorkFlowInstalledSub.Step GetFreeFlowStep(FoWoSoft.Data.Model.WorkFlowInstalled wfInstalled)
        {
            FoWoSoft.Data.Model.WorkFlowInstalledSub.Step step = new Data.Model.WorkFlowInstalledSub.Step();
            ...
            step.Buttons = new List<FoWoSoft.Data.Model.WorkFlowInstalledSub.StepSet.Button>() { 
                new FoWoSoft.Data.Model.WorkFlowInstalledSub.StepSet.Button()
                    {
