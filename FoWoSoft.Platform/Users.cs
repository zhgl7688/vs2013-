...
namespace FoWoSoft.Platform
{
    public class Users
    {
        ...
        private FoWoSoft.Data.Interface.IUsers dataUsers;
        public Users()
        {
        ...
        /// 新增
        /// </summary>
        public int Add(FoWoSoft.Data.Model.Users model)
        {
        ...
        /// 更新
        /// </summary>
        public int Update(FoWoSoft.Data.Model.Users model)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.Users> GetAll()
        {
        ...
        /// 查询单条记录
        /// </summary>
        public FoWoSoft.Data.Model.Users Get(Guid id)
        {
        ...
        /// 根据帐号查询一条记录
        /// </summary>
        public FoWoSoft.Data.Model.Users GetByAccount(string account)
        {
        ...
        {
            return FoWoSoft.Utility.Config.SystemInitPassword;
        }
        /// <summary>
        /// 得到加密后的密码字符串
        /// </summary>
        ...
        public string EncryptionPassword(string password)
        {
            ...
            FoWoSoft.Utility.HashEncrypt hash = new FoWoSoft.Utility.HashEncrypt();
        ...
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.Users> GetAllByOrganizeID(Guid organizeID)
        {
        ...
        /// <param name="organizeID"></param>
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.Users> GetAllByOrganizeIDArray(Guid[] organizeIDArray)
        {
        ...
        /// <param name="userID"></param>
        /// <returns></returns>
        public FoWoSoft.Data.Model.Organize GetDeptByUserID(Guid userID)
        { 
            ...
            var parents = new FoWoSoft.Platform.Organize().GetAllParent(stationID);
            parents.Reverse();
        ...
        /// 得到当前登录用户
        /// </summary>
        public static FoWoSoft.Data.Model.Users CurrentUser
        {
            get
            {
    ...
    public class UsersEqualityComparer : IEqualityComparer<FoWoSoft.Data.Model.Users>
    {
        public bool Equals(FoWoSoft.Data.Model.Users user1, FoWoSoft.Data.Model.Users user2)
        {
            return user1 == null || user2 == null || user1.ID == user2.ID;
        }
        public int GetHashCode(FoWoSoft.Data.Model.Users user)
        {
