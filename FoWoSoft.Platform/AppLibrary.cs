...
namespace FoWoSoft.Platform
{
    ...
    {
        private string cacheKey = FoWoSoft.Utility.Keys.CacheKeys.AppLibrary.ToString();
        private FoWoSoft.Data.Interface.IAppLibrary dataAppLibrary;
        public AppLibrary()
        {
        ...
        /// 新增
        /// </summary>
        public int Add(FoWoSoft.Data.Model.AppLibrary model)
        {
        ...
        /// 更新
        /// </summary>
        public int Update(FoWoSoft.Data.Model.AppLibrary model)
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.AppLibrary> GetAll(bool fromCache=false)
        {
            if (!fromCache)
            {
            ...
            else
            {
                ...
                if (obj != null)
                {
                    return obj as List<FoWoSoft.Data.Model.AppLibrary>;
                }
                else
                {
        ...
        /// 查询单条记录
        /// </summary>
        public FoWoSoft.Data.Model.AppLibrary Get(Guid id, bool fromCache=false)
        {
            if (!fromCache)
            {
        ...
        {
            FoWoSoft.Cache.IO.Opation.Remove(cacheKey);
        }
        /// <summary>
        /// 删除
        /// </summary>
        ...
        /// <returns></returns>
        public List<FoWoSoft.Data.Model.AppLibrary> GetPagerData(out string pager, string query = "", string title = "", string type = "", string address = "")
        {
            return dataAppLibrary.GetPagerData(out pager, query, "Type,Title", FoWoSoft.Utility.Tools.GetPageSize(),
                FoWoSoft.Utility.Tools.GetPageNumber(), title, type, address);
        }
        /// <summary>
        /// 查询一个类别下所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.AppLibrary> GetAllByType(Guid type)
        {
            if (type.IsEmptyGuid())
            {
                return new List<FoWoSoft.Data.Model.AppLibrary>();
            }
        ...
        /// 根据代码查询一条记录
        /// </summary>
        public FoWoSoft.Data.Model.AppLibrary GetByCode(string code)
        {
        ...
        /// <returns></returns>
        public string GetFlowRunAddress(FoWoSoft.Data.Model.AppLibrary app, string query="")
        {
