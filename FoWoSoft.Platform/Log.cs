...
namespace FoWoSoft.Platform
{
    public class Log
    {
        private FoWoSoft.Data.Interface.ILog dataLog;
        private static FoWoSoft.Data.Interface.ILog dataLog1 = Data.Factory.Factory.GetLog();
        private delegate void dgWriteLog(FoWoSoft.Data.Model.Log log);
        public Log()
        {
        ...
        /// 查询所有记录
        /// </summary>
        public List<FoWoSoft.Data.Model.Log> GetAll()
        {
        ...
        /// 查询单条记录
        /// </summary>
        public FoWoSoft.Data.Model.Log Get(Guid id)
        {
        ...
        {
            return dataLog.GetPagerData(out pager, query, FoWoSoft.Utility.Tools.GetPageSize(), FoWoSoft.Utility.Tools.GetPageNumber(),
