...
namespace FoWoSoft.Platform
{
    public class WorkGroup
    {
        ...
        private FoWoSoft.Data.Interface.IWorkGroup dataWorkGroup;
        public WorkGroup()
        {
        ...
        public string GetUsersNames(string members, char split = ',')
        {
            ...
            var users = new FoWoSoft.Platform.Organize().GetAllUsers(members);
        ...
        /// <param name="split"></param>
        /// <returns></returns>
        public string GetUsersNames(FoWoSoft.Data.Model.WorkGroup wg, char split = ',')
        {
