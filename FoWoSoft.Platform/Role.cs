...
namespace FoWoSoft.Platform
{
    public class Role
    {
        private FoWoSoft.Data.Interface.IRole dataRole;
        public Role()
        {
        ...
        /// <returns></returns>
        public string GetRoleOptions(string value = "", string hideID = "", IEnumerable<FoWoSoft.Data.Model.Role> roleList = null)
        {
