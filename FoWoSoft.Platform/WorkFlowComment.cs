...
namespace FoWoSoft.Platform
{
    ...
    {
        private FoWoSoft.Data.Interface.IWorkFlowComment dataWorkFlowComment;
        ...
        {
            string key = FoWoSoft.Utility.Keys.CacheKeys.WorkFlowComments.ToString();
            if (!fromCache)
            {
        ...
        {
            FoWoSoft.Cache.IO.Opation.Remove(FoWoSoft.Utility.Keys.CacheKeys.WorkFlowComments.ToString());
        }
        /// <summary>
        /// 刷新缓存
        /// </summary>
        ...
        {
            FoWoSoft.Cache.IO.Opation.Set(FoWoSoft.Utility.Keys.CacheKeys.WorkFlowComments.ToString(), getAllListByDb());
        }
        /// <summary>
        /// 得到一个用户的所有意见
        /// </summary>
