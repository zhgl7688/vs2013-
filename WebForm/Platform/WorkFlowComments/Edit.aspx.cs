...
namespace WebForm.Platform.WorkFlowComments
{
    public partial class Edit : Common.BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            FoWoSoft.Data.Model.WorkFlowComment workFlowComment = null;
            ...
            if (IsPostBack)
            {
                member = isOneSelf ? FoWoSoft.Platform.Users.PREFIX + FoWoSoft.Platform.Users.CurrentUserID.ToString() : Request.Form["Member"];
                ...
                {
                    workFlowComment = new FoWoSoft.Data.Model.WorkFlowComment();
                ...
                if (isAdd)
                {
                    ...
                    FoWoSoft.Platform.Log.Add("添加了流程意见", workFlowComment.Serialize(), FoWoSoft.Platform.Log.Types.流程相关);
                }
                else
                {
