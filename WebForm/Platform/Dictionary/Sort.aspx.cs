...
namespace WebForm.Platform.Dictionary
{
    ...
    {
        protected List<FoWoSoft.Data.Model.Dictionary> DictList = new List<FoWoSoft.Data.Model.Dictionary>();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ...
                BDict.RefreshCache();
                FoWoSoft.Platform.Log.Add("保存了数据字典排序", "保存了ID为：" + id + "的同级排序", FoWoSoft.Platform.Log.Types.数据字典);
