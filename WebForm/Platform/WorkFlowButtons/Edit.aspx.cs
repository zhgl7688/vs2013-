...
namespace WebForm.Platform.WorkFlowButtons
{
    public partial class Edit : Common.BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            FoWoSoft.Data.Model.WorkFlowButtons workFlowButton = null;
            ...
            if (IsPostBack)
            {
                ...
                {
                    workFlowButton = new FoWoSoft.Data.Model.WorkFlowButtons();
                ...
                if (isAdd)
                {
                    ...
                    FoWoSoft.Platform.Log.Add("添加了流程按钮", workFlowButton.Serialize(), FoWoSoft.Platform.Log.Types.流程相关);
                }
                else
                {
                    bworkFlowButtons.Update(workFlowButton);
                    FoWoSoft.Platform.Log.Add("修改了流程按钮", "", FoWoSoft.Platform.Log.Types.流程相关, oldXML, workFlowButton.Serialize());
                }
