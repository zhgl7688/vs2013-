...
namespace WebForm.Platform.WorkFlowButtons
{
    ...
    {
        protected IEnumerable<FoWoSoft.Data.Model.WorkFlowButtons> workFlowButtonsList;
                ...
                if (!Request.Form["DeleteBut"].IsNullOrEmpty())
                {
                    ...
                    foreach (string id in ids.Split(','))
                    {
                        ...
                        if (but != null)
                        {
                            ...
                            FoWoSoft.Platform.Log.Add("删除了流程按钮", but.Serialize(), FoWoSoft.Platform.Log.Types.流程相关);
                        }
                    }
