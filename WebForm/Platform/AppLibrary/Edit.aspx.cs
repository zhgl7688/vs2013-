...
namespace WebForm.Platform.AppLibrary
{
    public partial class Edit : Common.BasePage
    {
        ...
        FoWoSoft.Data.Model.AppLibrary appLibrary = null;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                isAdd = true;
                appLibrary = new FoWoSoft.Data.Model.AppLibrary();
            ...
            if (isAdd)
            {
                ...
                FoWoSoft.Platform.Log.Add("添加了应用程序库", appLibrary.Serialize(), FoWoSoft.Platform.Log.Types.角色应用);
            ...
            else
            {
                ...
                FoWoSoft.Platform.Log.Add("修改了应用程序库", "", FoWoSoft.Platform.Log.Types.角色应用, oldXML, appLibrary.Serialize());
