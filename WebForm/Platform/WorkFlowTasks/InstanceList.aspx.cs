...
namespace WebForm.Platform.WorkFlowTasks
{
    public partial class InstanceList : Common.BasePage
    {
        ...
        protected IEnumerable<FoWoSoft.Data.Model.WorkFlowTask> taskList;
        ...
        protected void Page_Load(object sender1, EventArgs e)
        {
            ...
            //可管理的流程ID数组
            var flows = bworkFlow.GetInstanceManageFlowIDList(FoWoSoft.Platform.Users.CurrentUserID, typeid);
            ...
            taskList = bworkFlowTask.GetInstances(manageFlows, new Guid[] { },
                sender.IsNullOrEmpty() ? new Guid[] { } : new Guid[] { sender.Replace(FoWoSoft.Platform.Users.PREFIX, "").ToGuid() },
