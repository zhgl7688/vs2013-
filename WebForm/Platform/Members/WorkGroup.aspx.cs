...
namespace WebForm.Platform.Members
{
    ...
    {
        protected FoWoSoft.Platform.WorkGroup bwg = new FoWoSoft.Platform.WorkGroup();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Guid wid;
            FoWoSoft.Data.Model.WorkGroup wg = null;
            name = string.Empty;
            ...
            if (!Request.Form["Save"].IsNullOrEmpty() && IsPostBack && wg != null)
            {
                ...
                FoWoSoft.Platform.Log.Add("修改了工作组", "修改了工作组", FoWoSoft.Platform.Log.Types.组织机构, oldxml, wg.Serialize());
            ...
            if (!Request.Form["DeleteBut"].IsNullOrEmpty() && IsPostBack && wg != null)
            {
                ...
                bwg.Delete(wg.ID);
                string query = Request.Url.Query;
                FoWoSoft.Platform.Log.Add("删除了工作组", oldxml, FoWoSoft.Platform.Log.Types.组织机构);
