...
<%
    ...
    FoWoSoft.Platform.WorkFlowForm bworkflowform = new FoWoSoft.Platform.WorkFlowForm();
    string link_DBConnOptions = bdbConn.GetAllOptions();
    string typeOptions = bworkflowform.GetTypeOptions("");
    string validatePromptType = new FoWoSoft.Platform.WorkFlowForm().GetValidatePropTypeRadios("validatealerttype","","");
%>
<br />
