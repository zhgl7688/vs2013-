...
<%
    ...
    FoWoSoft.Platform.WorkFlowForm workFlowFrom = new FoWoSoft.Platform.WorkFlowForm();
%>
<div class="wrapper">
            ...
            <table border="0" style="width:100%;">
                ...
                <tr>
                    <td colspan="2" style="padding-top:4px;">
                         <div>数据连接：<select class="myselect" id="ds_sql_dbconn"><%=new FoWoSoft.Platform.DBConnection().GetAllOptions() %></select>
