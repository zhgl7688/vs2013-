...
<body>
    ...
    <div style="margin:0 auto; text-align:center; padding-top:100px;">
        ...
        <div style="margin-top:80px;">您的签名：
            <%
              string signFile = string.Concat(Server.MapPath(WebForm.Common.Tools.BaseUrl + "/Files/UserSigns/"), FoWoSoft.Platform.Users.CurrentUserID, ".gif");
              string signSrc = string.Concat(WebForm.Common.Tools.BaseUrl + "/Files/UserSigns/", FoWoSoft.Platform.Users.CurrentUserID, ".gif");
