...
public static class MyExtensions
{
    ...
    {
        return FoWoSoft.Utility.Encryption.Encrypt(str);
    }
    /// <summary>
    /// AES解密字符串
    /// </summary>
    ...
    {
        return FoWoSoft.Utility.Encryption.Decrypt(str);
    }
    ...
    {
        return FoWoSoft.Utility.EncryptionDes.Encrypt(str);
    }
    /// <summary>
    /// DES解密字符串
    /// </summary>
    ...
    {
        return FoWoSoft.Utility.EncryptionDes.Decrypt(str);
    }
    ...
    {
        return date.ToDateTime().ToString(FoWoSoft.Utility.Config.DateFormat);
    }

    public static string ToDateTimeString(this string dateTime)
    {
        return dateTime.ToDateTime().ToString(FoWoSoft.Utility.Config.DateTimeFormat);
    }

    public static string ToDateTimeStringS(this string dateTime)
    {
        return dateTime.ToDateTime().ToString(FoWoSoft.Utility.Config.DateTimeFormatS);
    }

    public static string ToDateString(this DateTime date)
    {
        return date.ToString(FoWoSoft.Utility.Config.DateFormat);
    }

    public static string ToDateTimeString(this DateTime dateTime)
    {
        return dateTime.ToString(FoWoSoft.Utility.Config.DateTimeFormat);
    }

    public static string ToDateTimeStringS(this DateTime dateTime)
    {
        return dateTime.ToString(FoWoSoft.Utility.Config.DateTimeFormatS);
    }
}
