...
namespace FoWoSoft.Data.Interface
{
    public interface IUsers
    {
        ...
        /// 新增
        /// </summary>
        int Add(FoWoSoft.Data.Model.Users model);

        /// <summary>
        /// 更新
        /// </summary>
        int Update(FoWoSoft.Data.Model.Users model);

        /// <summary>
        /// 查询所有记录
        /// </summary>
        List<FoWoSoft.Data.Model.Users> GetAll();
        ...
        /// 根据帐号查询一条记录
        /// </summary>
        FoWoSoft.Data.Model.Users GetByAccount(string account);
