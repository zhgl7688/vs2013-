...
namespace FoWoSoft.Data.Interface
{
    public interface IWorkFlowArchives
    {
        ...
        /// 新增
        /// </summary>
        int Add(FoWoSoft.Data.Model.WorkFlowArchives model);

        /// <summary>
        /// 更新
        /// </summary>
        int Update(FoWoSoft.Data.Model.WorkFlowArchives model);

        /// <summary>
        /// 查询所有记录
        /// </summary>
        List<FoWoSoft.Data.Model.WorkFlowArchives> GetAll();
